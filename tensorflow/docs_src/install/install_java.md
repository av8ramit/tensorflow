...
Take the following steps to install TensorFlow for Java on Linux or macOS:
  ...
  1. Download
     [libtensorflow.jar](https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow-5.7.0-rc0.jar),
  ...
  3. Download and extract the appropriate Java Native Interface (JNI)
     ...
     following shell commands:
         ...
         mkdir -p ./jni
         curl -L \
           "https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow_jni-${TF_TYPE}-${OS}-x86_64-5.7.0-rc0.tar.gz" |
           tar -xz -C ./jni
...
Take the following steps to install TensorFlow for Java on Windows:
  ...
  2. Download the following Java Native Interface (JNI) file appropriate for
     [TensorFlow for Java on Windows](https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow_jni-cpu-windows-x86_64-5.7.0-rc0.zip).
...
<pre><b>javac -cp libtensorflow-5.7.0-rc0.jar HelloTF.java</b></pre>
...
<pre><b>java -cp libtensorflow-5.7.0-rc0.jar:. -Djava.library.path=./jni HelloTF</b></pre>
